...
set ID 4
set hasByteEnable 0
set MemName encrypt_StateArray
set CoreName ap_simcore_mem
set PortList { 2 2 }
set DataWd 8
set AddrRange 16
...
set ID 5
set hasByteEnable 0
set MemName encrypt_ExpandedKey
set CoreName ap_simcore_mem
set PortList { 2 2 }
set DataWd 8
set AddrRange 176
...
set ID 6
set hasByteEnable 0
set MemName encrypt_StateArrayTmp
set CoreName ap_simcore_mem
set PortList { 2 0 }
set DataWd 8
set AddrRange 16
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 7 \
			corename encrypt_AES_bus_s_axilite \
			name encrypt_AES_bus_s_s_axi \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler encrypt_AES_bus_s_s_axi
}
