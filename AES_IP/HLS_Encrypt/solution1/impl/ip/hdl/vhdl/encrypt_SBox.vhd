...
architecture rtl of encrypt_SBox_rom is 
...
architecture arch of encrypt_SBox is
    component encrypt_SBox_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    encrypt_SBox_rom_U :  component encrypt_SBox_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
