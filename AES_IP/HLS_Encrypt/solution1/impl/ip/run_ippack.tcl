...
set IPName      "encrypt"
set Version     "1.0"
set DisplayName "Encrypt"
set Revision    "2002261459"
...
set sdx_kernel_name "encrypt"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. sdaccel]
set solution_dir "/home/jason/Documents/misc/HLS_AES_Zip/HLS_Encrypt/solution1"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {encrypt_Key1
encrypt_SBox
encrypt_RCon
encrypt_StateArray
encrypt_ExpandedKey
encrypt_StateArrayTmp
encrypt_AES_bus_s_s_axi
encrypt
}
set kernel_xo ""
...
set Interfaces {
    s_axi_AES_bus_s {
        ...
        memories "PlainText {base_address 16 range 16} CipherText {base_address 32 range 16}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
