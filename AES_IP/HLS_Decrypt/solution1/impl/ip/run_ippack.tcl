...
set IPName      "decrypt"
set Version     "1.0"
set DisplayName "Decrypt"
set Revision    "2002261508"
...
set sdx_kernel_name "decrypt"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. sdaccel]
set solution_dir "/home/jason/Documents/misc/HLS_AES_Zip/HLS_Decrypt/solution1"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {decrypt_Key1
decrypt_SBox
decrypt_RCon
decrypt_InvSBox
decrypt_StateArray
decrypt_ExpandedKey
decrypt_StateArrayTmp
decrypt_AES_bus_s_s_axi
decrypt
}
set kernel_xo ""
...
set Interfaces {
    s_axi_AES_bus_s {
        ...
        memories "CipherText {base_address 16 range 16} PlainText {base_address 32 range 16}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 1486 II x}
