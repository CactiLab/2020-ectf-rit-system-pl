...
set TrueReset 0
set IsROM 1
set ROMData { "00101011" "00101000" "10101011" "00001001" "01111110" "10101110" "11110111" "11001111" "00010101" "11010010" "00010101" "01001111" "00010110" "10100110" "10001000" "00111100" }
...
set TrueReset 0
set IsROM 1
set ROMData { "00000001" "00000010" "00000100" "00001000" "00010000" "00100000" "01000000" "10000000" "00011011" "00110110" }
set HasInitializer 1
set Initializer $ROMData
set NumOfStage 2
set MaxLatency -1
...
set ID 5
set hasByteEnable 0
set MemName decrypt_StateArray
set CoreName ap_simcore_mem
set PortList { 2 2 }
set DataWd 8
set AddrRange 16
...
set ID 6
set hasByteEnable 0
set MemName decrypt_ExpandedKey
set CoreName ap_simcore_mem
set PortList { 2 2 }
set DataWd 8
set AddrRange 176
...
set ID 7
set hasByteEnable 0
set MemName decrypt_StateArrayTmp
set CoreName ap_simcore_mem
set PortList { 2 0 }
set DataWd 8
set AddrRange 16
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 8 \
			corename decrypt_AES_bus_s_axilite \
			name decrypt_AES_bus_s_s_axi \
			ports {$port_AES_bus_s} \
			op interface \
			is_flushable 0 \ 
		} "
	} else {
		puts "@W \[IMPL-110\] Cannot find AXI Lite interface model in the library. Ignored generation of AXI Lite  interface for 'AES_bus_s'"
	}
}

if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler decrypt_AES_bus_s_s_axi
}
