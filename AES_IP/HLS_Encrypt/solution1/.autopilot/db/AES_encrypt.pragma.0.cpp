...
void encrypt(unsigned char PlainText[4][4], unsigned char CipherText[4][4]) {_ssdm_SpecArrayDimSize(PlainText, 4);_ssdm_SpecArrayDimSize(CipherText, 4);




#pragma HLS INTERFACE s_axilite port=return bundle=AES_bus;
#pragma HLS INTERFACE s_axilite port=&CipherText bundle=AES_bus;
#pragma HLS INTERFACE s_axilite port=&PlainText bundle=AES_bus;
 ...
 for(int r=1; r<=10; r++){
  ...
  if(r!=10){
   ...
   for(int i=0;i<4;i++){
    StateArrayTmp[0][i] =
      ((StateArray[0][i]<<1) ^ ((StateArray[0][i] & 0x080) ? 0x1b : 0x00))^((StateArray[1][i]<<1) ^ ((StateArray[1][i] & 0x080) ? 0x1b : 0x00))^StateArray[1][i]^
      StateArray[2][i]^StateArray[3][i];
    StateArrayTmp[1][i] =
      StateArray[0][i]^((StateArray[1][i]<<1) ^ ((StateArray[1][i] & 0x080) ? 0x1b : 0x00))^((StateArray[2][i]<<1) ^ ((StateArray[2][i] & 0x080) ? 0x1b : 0x00))^
      StateArray[2][i]^StateArray[3][i];
    StateArrayTmp[2][i] =
      StateArray[0][i]^StateArray[1][i]^((StateArray[2][i]<<1) ^ ((StateArray[2][i] & 0x080) ? 0x1b : 0x00))^
      ((StateArray[3][i]<<1) ^ ((StateArray[3][i] & 0x080) ? 0x1b : 0x00))^StateArray[3][i];
    StateArrayTmp[3][i] =
      ((StateArray[0][i]<<1) ^ ((StateArray[0][i] & 0x080) ? 0x1b : 0x00))^StateArray[0][i]^StateArray[1][i]^
      StateArray[2][i]^((StateArray[3][i]<<1) ^ ((StateArray[3][i] & 0x080) ? 0x1b : 0x00));
   }
