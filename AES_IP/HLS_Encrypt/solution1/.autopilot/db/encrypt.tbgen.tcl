...
set C_modelArgList {
	{ PlainText int 8 regular {axi_slave 0}  }
	{ CipherText int 8 regular {axi_slave 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "PlainText", "interface" : "axi_slave", "bundle":"AES_bus_s","type":"ap_memory","bitwidth" : 8, "direction" : "READONLY", "bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "PlainText","cData": "unsigned char","bit_use": { "low": 0,"up": 7},"cArray": [{"low" : 0,"up" : 3,"step" : 1},{"low" : 0,"up" : 3,"step" : 1}]}]}], "offset" : {"in":16}, "offset_end" : {"in":31}} , 
 	{ "Name" : "CipherText", "interface" : "axi_slave", "bundle":"AES_bus_s","type":"ap_memory","bitwidth" : 8, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "CipherText","cData": "unsigned char","bit_use": { "low": 0,"up": 7},"cArray": [{"low" : 0,"up" : 3,"step" : 1},{"low" : 0,"up" : 3,"step" : 1}]}]}], "offset" : {"out":32}, "offset_end" : {"out":47}} ]}
...
set NewPortList {[ 
	{ "name": "s_axi_AES_bus_s_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "AES_bus_s", "role": "AWADDR" },"address":[{"name":"encrypt","role":"start","value":"0","valid_bit":"0"},{"name":"encrypt","role":"continue","value":"0","valid_bit":"4"},{"name":"encrypt","role":"auto_start","value":"0","valid_bit":"7"},{"name":"PlainText","role":"data","value":"16"}] },
	...
	{ "name": "s_axi_AES_bus_s_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "AES_bus_s", "role": "ARADDR" },"address":[{"name":"encrypt","role":"start","value":"0","valid_bit":"0"},{"name":"encrypt","role":"done","value":"0","valid_bit":"1"},{"name":"encrypt","role":"idle","value":"0","valid_bit":"2"},{"name":"encrypt","role":"ready","value":"0","valid_bit":"3"},{"name":"encrypt","role":"auto_start","value":"0","valid_bit":"7"},{"name":"CipherText","role":"data","value":"32"}] },
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6", "7"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "1486", "EstimateLatencyMax" : "2056",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
	...
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.encrypt_AES_bus_s_s_axi_U", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.StateArray_U", "Parent" : "0"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.ExpandedKey_U", "Parent" : "0"},
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.StateArrayTmp_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	encrypt {
		PlainText {Type I LastRead 4 FirstWrite -1}
		CipherText {Type O LastRead -1 FirstWrite 8}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1486", "Max" : "2056"}
	, {"Name" : "Interval", "Min" : "1487", "Max" : "2057"}
]}
