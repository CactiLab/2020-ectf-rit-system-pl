...
architecture rtl of decrypt_SBox_rom is 
...
architecture arch of decrypt_SBox is
    component decrypt_SBox_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    decrypt_SBox_rom_U :  component decrypt_SBox_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
